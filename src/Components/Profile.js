    ...
    render(){
        return(
            ...
            <div className="flex gap-5 sm:justify-between ">
                <h2 className="sm:text-xl text-md font-semibold">Software Engineer</h2>
            ...
            <p>"I am a Software Engineer, and I believe creating something new everyday will help you to learn alot.</p>
             <p>I have passion for Software Developement, but on the other side, I enjoy developing something new."</p>
             </div>
            </div>
            </div>
        )
